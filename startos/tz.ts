// Auto-generated: the full IANA timezone database (Intl.supportedValuesOf), plus UTC.
// Regenerate with the node snippet in this package's history if the tz database changes.
// Keys are the IANA names passed to the container as TZ; values are display labels.
